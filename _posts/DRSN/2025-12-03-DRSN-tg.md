...
'Et elli **sub-network**, qeddam nay kullu features 'et input feature map absolute values tehasseb. Ebbe, be **global average pooling** w average, hade feature lirkkab, $A$ behil. 'Et la kal'e menged, feature map dib **global average pooling** n' ne'ish **fully connected network** li'atu. 'Elli **fully connected network** **Sigmoid function** kem mecherresta layer yetneffe', output 'et 0 w 1 let'eses, $\alpha$ zibbehal coefficient n'merkhab. La mecherresta threshold $\alpha \times A$ tu. Sileze, threshold hasli darb nay number 'et 0 w 1 mis average nay absolute values nay feature map tu. **'Elli menged threshold positive kem ligebbi', w 'aze kem ze'ye'abi le'tehaqaqqe tu.**
