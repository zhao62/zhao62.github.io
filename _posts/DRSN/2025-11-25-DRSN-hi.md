...
ऐसा इसलिए है क्योंकि कई बार Samples में Noise की मात्रा अलग-अलग होती है। उदाहरण के लिए, एक ही Sample Set में Sample A में कम Noise हो सकता है और Sample B में ज्यादा। ऐसे में, Denoising Algorithm में Soft Thresholding करते समय, Sample A के लिए छोटा Threshold और Sample B के लिए बड़ा Threshold इस्तेमाल किया जाना चाहिए। Deep Neural Network में, भले ही इन Features और Thresholds का स्पष्ट भौतिक अर्थ (Physical Meaning) न हो, लेकिन मूल तर्क वही रहता है। यानी, हर Sample का उसके Noise Content के अनुसार अपना अलग Threshold होना चाहिए।
