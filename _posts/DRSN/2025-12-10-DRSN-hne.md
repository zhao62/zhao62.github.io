...
इस **sub-network** म, **system** सबले पहली **input feature map** के सभी **features** के **absolute values calculate** करथे। फिर, **system** ह **global average pooling** अउ **averaging** करथे ताकि एक **feature** मिल सके, जेला $A$ माना गे हे। दूसरी तरफ, **system** ह **global average pooling** के बाद **feature map** ल एक छोटे **fully connected network** म डाल देथे। यह **fully connected network** आखिरी **layer** के रूप म **Sigmoid function** **use** करथे। यह **function** ह **output** ल 0 अउ 1 के बीच म **normalize** कर देथे। इस **process** से एक **coefficient** मिलथे, जेला $\alpha$ माना गे हे। हमन **final threshold** ल $\alpha \times A$ बता सकथन। इसलिए, **threshold** ह दुइ **number** के गुणा (**product**) हरय। एक **number** 0 अउ 1 के बीच हे। दूसरा **number** **feature map** के **absolute values** के **average** हे। **यह तरीका सुनिश्चित करथे कि threshold positive रहय। यह तरीका यह भी पक्का करथे कि threshold बहुत ज्यादा बड़ा न होय।**
