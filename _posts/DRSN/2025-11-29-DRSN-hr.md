...
mathjax: true
description: "Deep Residual Shrinkage Network (DRSN) je poboljšana varijanta Deep Residual Networka (ResNet). U suštini, radi se o integraciji ResNeta, mehanizama pažnje (attention mechanisms) i funkcija mekog pragovanja (soft thresholding)."
---
