...
mathjax: true
description: "Deep Residual Shrinkage Network (DRSN) asal wich Deep Residual Network (ResNet) da hi ikk improved version hai. Asal wich eh ResNet, Attention Mechanism ate Soft Thresholding functions da ikk integration (mel-jol) hai."
---
