...
এই sub-network-ত, প্ৰথমতে input feature map-ৰ সকলো features-ৰ absolute values লোৱা হয়। তাৰপিছত **global average pooling** আৰু averaging কৰি এটা feature পোৱা যায়, যাক A বুলি ধৰা হয়। আনটো পথত, global average pooling-ৰ পিছত feature map-খন এটা সৰু fully connected network-লৈ পঠিওৱা হয়। এই fully connected network-এ **Sigmoid function**-ক ইয়াৰ শেষ স্তৰ (last layer) হিচাপে ব্যৱহাৰ কৰি output-টো 0 আৰু 1-ৰ মাজত normalize কৰে আৰু এটা coefficient পায়, যাক $\alpha$ বুলি ধৰা হয়। চূড়ান্ত threshold-ক $\alpha \times A$ হিচাপে প্ৰকাশ কৰিব পাৰি। সেয়েহে, threshold হৈছে 0 আৰু 1-ৰ মাজৰ এটা সংখ্যা আৰু feature map-ৰ absolute values-ৰ গড়ৰ গুণফল। **এই পদ্ধতিয়ে নিশ্চিত কৰে যে threshold-টো কেৱল positive-এ নহয়, বৰ বেছি ডাঙৰো নহয়।**
