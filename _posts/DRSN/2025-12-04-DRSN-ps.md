...
Squeeze-and-Excitation Network (SENet) یو نسبتا نوی deep learning میتود دی چې د attention mechanisms څخه کار اخلي. په مختلفو samples کې، د classification task لپاره د مختلفو feature channels ونډه (contribution) اکثرا توپیر لري. SENet یو کوچنی sub-network کاروي ترڅو د وزنونو یوه ټولګه زده کړي (**Learn a set of weights**)، او بیا دا weights د اړوندو channels د features سره ضرب کوي ترڅو په هر channel کې د features کچه تنظیم کړي (**Apply weighting to each feature channel**). دا پروسه په مختلفو feature channels باندې د **Weighting** پلي کولو په توګه لیدل کیدی شي.
...
په نهایت کې، د یو ټاکلي شمیر basic modules د **Stack many basic modules** په توګه یوځای کولو سره، د convolutional layers، batch normalization، activation functions، global average pooling، او fully connected output layers سره یوځای، بشپړ Deep Residual Shrinkage Network جوړیږي.
