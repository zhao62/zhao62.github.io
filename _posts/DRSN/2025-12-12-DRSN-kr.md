...
**Koro, noise amount samples lan gawazin. Falke ade dataset fal lan ma sadin.** (Falke ade **attention mechanisms** ro kama. **Image dataset** gonin misal ma. **Location** na **target object** **images** lan gawazin. **Attention mechanisms** ye **focus** tukin **specific location** na **target object** **image** kowa lan.)
