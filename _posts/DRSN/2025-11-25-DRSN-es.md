...
**El *soft thresholding* es fundamental en la reducción de ruido. Consiste en eliminar las características cuyo valor absoluto es menor que un umbral ($\tau$) y "contraer" hacia cero aquellas cuyo valor absoluto es mayor.** La fórmula es:
