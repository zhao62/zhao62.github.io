...
## 9. Избранные исследования и последние достижения
...
Если вас интересует Deep Residual Shrinkage Network, возможно, вам также будет интересно ознакомиться с другими нашими исследованиями. Ниже приведен список некоторых наших статей.
