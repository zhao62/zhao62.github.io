...
**Deep Residual Shrinkage Network की इंटरप्रिटेबिलिटी (Interpretability) काफी उच्च है। इसके कार्य सिद्धांत को इस प्रकार समझा जा सकता है: यह Attention Mechanism के ज़रिए "unimportant features" को नोटिस करता है और Soft Thresholding Function का इस्तेमाल करके उन्हें ज़ीरो (zero) कर देता है; या दूसरे शब्दों में, यह important features को नोटिस करता है और उन्हें retain करता है (बचा कर रखता है)। इससे Deep Neural Network की noisy signals से useful features निकालने की क्षमता (ability) बढ़ जाती है।**
...
## 9. अनुसंधान के मुख्य अंश और नवीनतम प्रगति
...
यदि आप Deep Residual Shrinkage Network में रुचि रखते हैं, तो आप हमारे अन्य शोधों को भी देखना चाह सकते हैं। नीचे हमारे कुछ शोध पत्र सूचीबद्ध हैं।
