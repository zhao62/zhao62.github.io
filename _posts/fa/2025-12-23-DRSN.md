...
**شبکه Deep Residual Shrinkage Network از تفسیرپذیری (Interpretability) بالایی برخوردار است. اصول کاری آن را می‌توان این‌گونه درک کرد: این شبکه با استفاده از مکانیزم Attention، ویژگی‌های (features) غیرمهم را شناسایی کرده و از طریق تابع Soft thresholding آن‌ها را صفر می‌کند؛ یا به عبارت دیگر، روی ویژگی‌های مهم تمرکز کرده و آن‌ها را حفظ می‌نماید. این فرآیند، توانایی Deep Neural Network را در استخراج ویژگی‌های مفید از سیگنال‌های حاوی نویز (Noise) تقویت می‌کند.**
...
## 9. گزیده پژوهش‌ها و آخرین پیشرفت‌ها
...
اگر به Deep Residual Shrinkage Network علاقه‌مند هستید، بد نیست نگاهی به سایر پژوهش‌های ما نیز بیندازید. در ادامه لیستی از برخی مقالات ما آمده است.
