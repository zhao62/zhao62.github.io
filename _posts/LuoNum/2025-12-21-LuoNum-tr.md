...
mathjax: true
description: "Bu çalışma, piston segmanı, piston ve silindir gömleği sistemine odaklanarak, 2B akışkan alanı ile 3B segman yapısını entegre eden bağlaşık (coupled) bir model oluşturmaktadır."
---
