...
**A Rede Residual Profunda de Contração apresenta alta interpretabilidade. O seu princípio de funcionamento pode ser compreendido como: ela utiliza mecanismos de atenção para identificar características (features) não importantes e emprega funções de limiarização suave para zerá-las; ou, dito de outra forma, identifica características importantes e as preserva. Esse processo fortalece a capacidade da rede neural profunda de extrair características úteis de sinais que contêm ruído.**
