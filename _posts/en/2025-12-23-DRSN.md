...
**Deep Residual Shrinkage Networks have good interpretability. Their working principle can be understood as: it utilizes attention mechanisms to identify unimportant features and employs soft thresholding functions to set them to zero; conversely, it identifies important features and retains them. This process enhances the deep neural network's ability to extract useful features from signals containing noise.**
...
<p align="center">
  <img src="/assets/img/DRSN/2025-11-25-DRSN-en/Citation_DRSN.png" alt="Deep residual shrinkage networks for fault diagnosis" width="100%">
</p>
