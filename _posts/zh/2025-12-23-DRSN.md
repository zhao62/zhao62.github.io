...
<style>
  ...
  .meta-container {
    text-align: center;
    margin-top: 10px;  /* 顶部间距从30px减小到10px */
    margin-bottom: 20px; /* 底部间距从40px减小到20px */
  ...
  /* 具体配色方案 */
  .btn-academic { background-color: #2A5CA7; } /* 学术蓝：更亮眼、现代 */
  .btn-github   { background-color: #24292e; } /* GitHub黑：品牌原色 */
  ...
  .badge-cite {
    ...
    display: flex;
    align-items: center;
    border: 1px solid #FFE082; /* 金色边框 */
  }

  /* 手机端适配：屏幕宽度小于 600px 时触发 */
  @media (max-width: 600px) {
    .meta-btn, .badge-cite {
      font-size: 0.8em; /* 缩小字体 */
      padding: 5px 10px; /* 缩小按钮体积 */
    }
    .meta-container {
      margin-top: 5px;
      margin-bottom: 15px;
...
<div class="meta-container">
  <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 10px;">
    ...
    <a href="https://scholar.google.com/citations?user=k82TzLwAAAAJ&hl=en" target="_blank" class="meta-btn btn-academic">
      <span style="margin-right: 5px;">🎓</span> Google Scholar
    </a>

    <!-- IEEE 论文 -->
    <a href="https://ieeexplore.ieee.org/document/8850096" target="_blank" class="meta-btn btn-academic">
      <span style="margin-right: 5px;">📄</span> IEEE Paper
    </a>

    <!-- GitHub 代码 -->
    <a href="https://github.com/zhao62/Deep-Residual-Shrinkage-Networks" target="_blank" class="meta-btn btn-github">
      <span style="margin-right: 5px;">💻</span> GitHub Code
    </a>

    <!-- 引用量 -->
    <span class="badge-cite">
      <span style="margin-right: 5px;">⭐</span> Citations: 1400+
    </span>
...
<!-- 分割线：颜色变淡，间距变小 -->
<hr style="border: 0; height: 1px; background: #eaeaea; margin: 20px 0 30px 0;">
