...
<!-- 这是一个带有复制功能的 HTML 块 -->
<div style="position: relative; background: #f6f8fa; padding: 15px; border-radius: 6px; border: 1px solid #e1e4e8; font-family: monospace; font-size: 13px; overflow-x: auto;">
    <button onclick="copyBibtex()" style="position: absolute; top: 10px; right: 10px; background: #fff; border: 1px solid #d1d5da; border-radius: 4px; padding: 5px 10px; cursor: pointer; color: #24292e; font-size: 12px; font-weight: 600;">
        Copy BibTeX
    </button>
    <pre id="bibtex-content" style="margin: 0; white-space: pre-wrap;">@article{Zhao2020,
...
function copyBibtex() {
  ...
  navigator.clipboard.writeText(content).then(() => {
    ...
    // 或者你可以把按钮文字改成 "Copied!" 几秒钟，体验更好，但需要更多代码
  }).catch(err => {
