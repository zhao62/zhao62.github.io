...
<style>
  ...
  .meta-container {
    text-align: center;
    margin-top: 5px;   /* 极小的顶部间距 */
    margin-bottom: 10px; /* 极小的底部间距 */
  ...
  .meta-btn {
    ...
    font-size: 13px; 
    padding: 3px 10px; 
    border-radius: 4px; /* 改为小圆角，比椭圆更省空间，更像Badge */
    font-weight: 500;
    display: flex;
    align-items: center;
  ...
  .btn-icon {
    margin-right: 4px;
    font-size: 1.1em; /* 图标稍微比文字大一点点即可 */
    position: relative;
    top: -1px; /* 微调垂直对齐 */
  }

  /* 配色方案 */
  .btn-academic { background-color: #2A5CA7; }
  ...
  @media (max-width: 600px) {
    ...
    .meta-btn, .badge-cite { font-size: 12px; padding: 3px 8px; }
  }
</style>
