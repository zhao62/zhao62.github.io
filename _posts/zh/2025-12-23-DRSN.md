...
<!-- 隐藏原来的冗余名字，用更紧凑的方式展示单位和资源 -->
<div style="text-align: center; margin-top: -10px; margin-bottom: 30px; font-family: sans-serif;">
  
  <!-- 单位信息：使用深灰色，稍微加粗，紧接在日期后面 -->
  <div style="font-size: 1.1em; color: #555; margin-bottom: 15px;">
    <strong>Harbin Institute of Technology</strong>
  </div>

  <!-- 按钮组：使用 Flexbox 布局，适配移动端 -->
  <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 10px;">
    
    <!-- 谷歌学术按钮 -->
    <a href="https://scholar.google.com/citations?user=k82TzLwAAAAJ&hl=en" target="_blank" style="text-decoration: none;">
      <span style="background-color: #4285F4; color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.9em; display: flex; align-items: center;">
    ...
    <a href="https://ieeexplore.ieee.org/document/8850096" target="_blank" style="text-decoration: none;">
      <span style="background-color: #B31B1B; color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.9em; display: flex; align-items: center;">
        <span style="margin-right: 6px;">📄</span> IEEE Paper
      </span>
    </a>

    <!-- 代码库按钮 -->
    <a href="https://github.com/zhao62/Deep-Residual-Shrinkage-Networks" target="_blank" style="text-decoration: none;">
      <span style="background-color: #24292e; color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.9em; display: flex; align-items: center;">
        <span style="margin-right: 6px;">💻</span> GitHub Code
      </span>
    </a>

    <!-- 引用量展示 (静态徽章) -->
    <span style="background-color: #f6f8fa; color: #24292e; border: 1px solid #d1d5da; padding: 5px 11px; border-radius: 6px; font-size: 0.9em; display: flex; align-items: center;">
      <span style="margin-right: 6px; color: #e3b341;">⭐</span> Citations: 1400+
    </span>
