...
<!-- 1. CSS 修复区：优化页面的行间距和字体 -->
<style>
  /* 修复主题自带的头部拥挤问题 */
  .post-meta, header span {
    display: block; /* 强制换行 */
    margin-bottom: 8px !important; /* 增加行距 */
  ...
  .academic-btn {
    ...
    background-color: #003366; /* 哈工大蓝/学术深蓝 */
    color: white !important;
    padding: 8px 16px;
    border-radius: 50px; /* 胶囊形状，更现代 */
    font-size: 0.9em;
    font-weight: 500;
...
<!-- 2. 作者信息与资源区 -->
<div style="text-align: center; margin-top: 30px; margin-bottom: 40px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  
  <!-- 单位信息：加大字号，加深颜色 -->
  <div style="font-size: 1.2em; color: #2c3e50; font-weight: 600; margin-bottom: 20px;">
