...
<style>
  ...
  .meta-btn {
    ...
    font-size: 13px;       /* 保持小字号 */
    padding: 3px 10px;     /* 保持紧凑内边距 */
    border-radius: 4px;    /* 小圆角 */
    font-weight: 500;
    display: inline-flex;  /* 修正为 inline-flex 以便更好的一行排列 */
    align-items: center;
  ...
  /* 配色方案 */
  .btn-academic { background-color: #2A5CA7; } /* 学术蓝 */
  .btn-github   { background-color: #24292e; } /* GitHub黑 */
  
  /* 引用按钮的特殊样式 (现在是可点击的链接) */
  .btn-cite {
    background-color: #FFF8E1; /* 淡金色背景 */
    color: #B7791F !important; /*以此强制覆盖上面的白色文字 */
  ...
  /* 引用按钮悬停效果 */
  .btn-cite:hover {
    background-color: #FFECB3; /* 悬停变深一点 */
    color: #9A6310 !important;
  }

  /* 手机端适配 */
  @media (max-width: 600px) {
    .meta-container { margin-top: 0; margin-bottom: 10px; }
    .meta-btn { font-size: 12px; padding: 3px 8px; }
  }
</style>
...
<div class="meta-container">
  <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 8px;">
    ...
    <!-- 1. 哈工大主页 (新增) -->
    <a href="https://homepage.hit.edu.cn/zhaominghang?lang=zh" target="_blank" class="meta-btn btn-academic">
      <span class="btn-icon">🏠</span> HIT Homepage
    </a>

    <!-- 2. 谷歌学术 -->
    <a href="https://scholar.google.com/citations?user=k82TzLwAAAAJ&hl=en" target="_blank" class="meta-btn btn-academic">
      <span class="btn-icon">🎓</span> Google Scholar
    </a>

    <!-- 3. IEEE 论文 -->
    <a href="https://ieeexplore.ieee.org/document/8850096" target="_blank" class="meta-btn btn-academic">
    ...
    <!-- 5. 引用量 (现在也是链接) -->
    <a href="https://scholar.google.com/citations?user=k82TzLwAAAAJ&hl=en" target="_blank" class="meta-btn btn-cite">
