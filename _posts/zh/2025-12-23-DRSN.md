...
<!-- 简化后的按钮区代码：去掉了单位名称，因为上面已经有了 -->
<div style="text-align: center; margin-top: 30px; margin-bottom: 40px;">
  
  <!-- 按钮组 -->
  <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 12px;">
    
    <a href="https://scholar.google.com/citations?user=k82TzLwAAAAJ&hl=en" target="_blank" style="text-decoration: none; background-color: #003366; color: white; padding: 8px 16px; border-radius: 50px; font-size: 0.9em; display: flex; align-items: center;">
      <span style="margin-right: 6px;">🎓</span> Google Scholar
    </a>

    <a href="https://ieeexplore.ieee.org/document/8850096" target="_blank" style="text-decoration: none; background-color: #003366; color: white; padding: 8px 16px; border-radius: 50px; font-size: 0.9em; display: flex; align-items: center;">
      <span style="margin-right: 6px;">📄</span> IEEE Paper
    </a>

    <a href="https://github.com/zhao62/Deep-Residual-Shrinkage-Networks" target="_blank" style="text-decoration: none; background-color: #003366; color: white; padding: 8px 16px; border-radius: 50px; font-size: 0.9em; display: flex; align-items: center;">
      <span style="margin-right: 6px;">💻</span> GitHub Code
    </a>

    <span style="background-color: #f0f2f5; color: #444; padding: 8px 16px; border-radius: 50px; font-size: 0.9em; border: 1px solid #e1e4e8; display: flex; align-items: center;">
      <span style="margin-right: 6px; color: #f39c12;">⭐</span> Citations: 1400+
    </span>
