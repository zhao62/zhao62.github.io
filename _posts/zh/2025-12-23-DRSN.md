...
<style>
  ...
  .meta-btn {
    ...
    font-size: 13px;
    padding: 6px 12px;     /* 稍微增加一点舒适度 */
    border-radius: 6px;    /* 圆角稍微柔和一点 */
    font-weight: 500;
    display: inline-flex;
    align-items: center;
  ...
  /* 1. HIT主页: 藏青色 (沉稳、官方) */
  .btn-hit { background-color: #3f51b5; background: linear-gradient(135deg, #3f51b5, #3949ab); }
  
  /* 2. Google Scholar: 黛蓝色 (学术、冷静) */
  .btn-scholar { background-color: #4285f4; background: linear-gradient(135deg, #5c7cfa, #4c6ef5); }
  
  /* 3. IEEE: 蓝绿色/孔雀蓝 (科技、标准) - 降低了原版IEEE蓝的刺眼度 */
  .btn-ieee { background-color: #00838f; background: linear-gradient(135deg, #26a69a, #00897b); }
  
  /* 4. GitHub: 深岩灰 (代码、硬核) - 比纯黑更柔和 */
  .btn-github { background-color: #37474f; background: linear-gradient(135deg, #455a64, #37474f); }
  
  /* 5. 引用量: 哑光金/古铜色 (成就、高亮但不刺眼) */
  .btn-citations { 
    background-color: #f9a825; 
    background: linear-gradient(135deg, #fbc02d, #f9a825);
    font-weight: 600; /* 强调数字 */
  }

  /* 手机端适配 */
  @media (max-width: 600px) {
    .meta-btn { font-size: 12px; padding: 5px 10px; width: 100%; justify-content: center; }
  }
</style>

<!-- 按钮区 -->
<div class="meta-container">
  <!-- 使用 gap 属性来控制间距，比 margin 更现代 -->
