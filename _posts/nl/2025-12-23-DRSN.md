...
**Het Deep Residual Shrinkage Network is een verbeterde variant van het Deep Residual Network (ResNet). In essentie is het een integratie van ResNet, attention-mechanismen en soft-thresholdingfuncties.**

**Het Deep Residual Shrinkage Network heeft een hoge interpreteerbaarheid. Het werkingsprincipe kan worden begrepen als: via een attention mechanism worden onbelangrijke features geïdentificeerd, die vervolgens door een soft-thresholdingfunctie op nul worden gezet. Anders gezegd: het mechanisme herkent belangrijke features en behoudt deze. Dit versterkt het vermogen van het deep neural network om nuttige features te extraheren uit signalen die ruis bevatten.**
