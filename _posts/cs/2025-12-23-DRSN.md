...
**DRSN má vysokou interpretovatelnost. Princip fungování lze chápat následovně: pomocí mechanismu pozornosti identifikují nedůležité příznaky (features), které jsou následně vynulovány pomocí funkce měkkého prahování. Naopak důležité příznaky jsou identifikovány a zachovány. Tím se zvyšuje schopnost hluboké neuronové sítě extrahovat užitečné informace i ze signálů, které obsahují silný šum.**
...
## 9. Výběr z výzkumu a nejnovější pokroky
...
Pokud vás zajímá Deep Residual Shrinkage Network, mohly by vás zajímat i naše další výzkumy. Níže je uveden seznam některých našich článků.
