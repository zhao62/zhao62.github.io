...
**Deep Residual Shrinkage Network har hög tolkningsbarhet. Dess funktionsprincip kan förstås som: den använder attention-mekanismer för att identifiera oviktiga features och eliminerar dem via soft thresholding (sätter dem till noll); omvänt identifierar den viktiga features och behåller dem. Denna process stärker det djupa neurala nätverkets förmåga att extrahera användbara features från signaler som innehåller brus.**
