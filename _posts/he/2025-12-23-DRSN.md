...
<strong>ל-Deep Residual Shrinkage Network יש יכולת פרשנות (Interpretability) גבוהה. את עקרון הפעולה שלה ניתן להבין כך: באמצעות מנגנון Attention היא מזהה פיצ'רים (features) לא חשובים, ומאפסת אותם על ידי פונקציית Soft Thresholding; או במילים אחרות, היא מתמקדת בפיצ'רים החשובים ושומרת עליהם. תהליך זה מחזק את היכולת של הרשת הנוירונית העמוקה לחלץ פיצ'רים שימושיים מתוך אותות המכילים רעש.</strong>
